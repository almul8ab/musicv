...
async def play(_, message: Message):
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"🎸 ** تمت إضافة المقطع الصوتي إلى قائمة الانتظار »**` {position} `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🎪 ** Name: ** [{title [: 80]}] ({url}) \ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🗼 ** المدة: **` {duration} `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🍥 ** طلب من: ** {message.from_user.mention}",
            reply_markup=keyboard
        )
    else:
        chat_id = get_chat_id(message.chat)
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"🎸 **الاسم:** [{title[:80]}]({url})\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🍥 **الحاله:** `{duration}`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🎪 **طلب:** `قيد التشغيل`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n" \
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        chat_id,
        photo="final.png",
        caption=f"🎸 ** تمت إضافة المقطع الصوتي إلى قائمة الانتظار »**\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n{position} `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🗼 ** Name: ** [{title [: 80]}] ({url}) \ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🍥 ** المدة: **` {duration} `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🎪 ** طلب من: ** {r_by.mention}",
        reply_markup=keyboard,
        )
    else:
        que[chat_id] = []
        ...
        chat_id,
        photo="final.png",
        caption=f"🎸 ** الاسم: ** [{title [: 80]}] ({url})\n🍥 ** Duration: ** `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n{duration}`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🗼 ** الحالة: ** `قيد التشغيل`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n" 
...
async def ytplay(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        "🎸 ** لاستخدامي ، يجب أن أكون مسؤولاً مع الأذونات:\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n »❌ __ حذف الرسائل\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n» 🍥 __ حظر المستخدمين __ \ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n »🦹🏻 __إضافة مستخدمين __ \ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n» 🗼 __إدارة الدردشة الصوتية __ \ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n** بعد ذلك اكتب  إعادة التحميل ****",
                    )
                    return
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"🎸 ** تمت إضافة المقطع الصوتي إلى قائمة الانتظار »**`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n {position} `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n 🗼 ** Name: ** [{title [: 80]}] ({url}) \ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🍥 ** المدة: **` {duration} `\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🎪 ** طلب من: ** {message.from_user.mention}",
            reply_markup=keyboard
        )
    else:
        chat_id = get_chat_id(message.chat)
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"🗼 ** الاسم: ** [{title [: 80]}] ({url})\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🍥 ** Duration: ** `{duration}`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n🎸 ** الحالة: ** `قيد التشغيل`\ n   ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\ n" \
